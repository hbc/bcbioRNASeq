...
bcbioBase::readSampleData(sample_metadata_file)
```
...
```{r, message=FALSE}
plotCountsPerGene(bcb, geom = "density", interestingGroups = "sampleName")
...
```{r, eval=FALSE}
getMethod("coerce", signature(from = "bcbioRNASeq", to = "DESeqDataSet"))
```
