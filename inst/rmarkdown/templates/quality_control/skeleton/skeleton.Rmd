...
```{r plot_total_reads}
# getMethod("plotTotalReads", "bcbioRNASeq")
plotTotalReads(bcb)
```
...
```{r plot_mapped_reads}
# getMethod("plotMappedReads", "bcbioRNASeq")
plotMappedReads(bcb)
```
...
```{r plot_mapping_rate}
# getMethod("plotMappingRate", "bcbioRNASeq")
plotMappingRate(bcb)
```
...
# getMethod("plotGenesDetected", "bcbioRNASeq")
...
# getMethod("plotGeneSaturation", "bcbioRNASeq")

markdownHeader("Labeled")
plotGeneSaturation(
    object = bcb,
...
# getMethod("plotExonicMappingRate", "bcbioRNASeq")
...
# getMethod("plotIntronicMappingRate", "bcbioRNASeq")
...
# getMethod("plotRRNAMappingRate", "bcbioRNASeq")
...
# getMethod("plot5Prime3PrimeBias", "bcbioRNASeq")
...
# getMethod("plotCountDensity", "bcbioRNASeq")
...
```{r plot_disp_ests}
# getMethod("plotDispEsts", "bcbioRNASeq")
plotDispEsts(bcb)
```
...
```{r plot_mean_sd}
# getMethod("plotMeanSD", "bcbioRNASeq")
plotMeanSD(bcb)
```
...
# getMethod("plotPCACovariates", "bcbioRNASeq")
...
# getMethod("plotCorrelationHeatmap", "bcbioRNASeq")
