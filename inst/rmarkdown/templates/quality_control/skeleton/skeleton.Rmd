...
params:
  ...
  # Use bcbioRNASeq object as input.
  # - Standard: Load saved object from file on disk, either RDS or RDA.
  # - Advanced: Loop across multiple objects using `rmarkdown::render()` call.
  object: "rds/2019-04-03/bcb.rds"
  
  # The `name` param is only necessary when passing in object directly.
  # name: "object_name"
