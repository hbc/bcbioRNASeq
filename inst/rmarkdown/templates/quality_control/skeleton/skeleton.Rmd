...
params:
  bcbioRNASeq_file: "data/YYYY-MM-DD/bcb.rds"
...
```{r object}
object <- readRDS(file = params$bcbioRNASeq_file)
...
if ("geneBiotype" %in% colnames(rowData(object))) {
    plotCountsPerBiotype(object, normalized = "tpm")
} else {
...
if (!"broadClass" %in% colnames(rowData(object))) {
    plotCountsPerBroadClass(object, normalized = "tpm")
} else {
