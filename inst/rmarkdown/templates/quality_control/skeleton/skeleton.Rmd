...
params:
    ...
    results_dir: !r file.path("results", Sys.Date(), "counts")
---
...
# Visualize per sample by default
...
```{r plot_mean_sd}
plotMeanSD(bcb, return = "markdown", headerLevel = 3)
```
