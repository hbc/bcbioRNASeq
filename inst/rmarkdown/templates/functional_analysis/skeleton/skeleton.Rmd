...
Entrez IDs are required for KEGG analysis. Here we are defining 1:1 mappings of the Ensembl gene IDs to Entrez IDs. For genes that map to multiple Entrez IDs, we are using the oldest Entrez ID to define the 1:1 mapping.
