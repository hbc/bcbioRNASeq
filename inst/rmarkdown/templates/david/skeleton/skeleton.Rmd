#' Run \code{\link[RDAVIDWebService]{DAVIDWebService}}.
#'
...
#' @seealso
#' \itemize{
#'   \item \code{\link[RDAVIDWebService]{DAVIDWebService}}
#'   \item \code{\link[knitr]{kable}}
#' }


#' @rdname david
#' @description Wrapper that runs gene set enrichment analysis (GSEA) with
#'   \code{\link[RDAVIDWebService]{DAVIDWebService}}, using simplified input
#'   options.
#'
#' @param res_tbl \code{\link{res_tables}} list object.
...
#'   disk.
#'
#' @return List of \code{\link[RDAVIDWebService]{DAVIDWebService}} returns.
#' @export
run_david <- function(
    res_tbl,
    direction = "both",
...
#'
#' @param david DAVID results list generated by \code{\link{run_david}}.
#'
#' @return Cutoff chart \code{\link[knitr]{kable}}.
#' @export
