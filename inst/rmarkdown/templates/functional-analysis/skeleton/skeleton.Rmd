...
## We're setting mouse genome here by default, to follow the vignette example.
## Updated 2019-09-13.
params:
...
## Only the current Bioconductor release for this template is supported,
## because it's too difficult to unit test and properly handle code changes.
...
## FIXME There's a logical coercion error in DOSE.
...
## DOSE
##  --- call from context ---
## build_Anno(GO2GENE, get_GO2TERM_table())
##  --- call from argument ---
## missing(path2name) || is.null(path2name) || is.na(path2name)
##  --- R stacktrace ---
## where 1: build_Anno(GO2GENE, get_GO2TERM_table())
## where 2: get_GO_data(OrgDb, ont, keyType)
## where 3: enrichGO(gene = sig_genes, OrgDb = "org.Mm.eg.db", keyType = "ENSEMBL",
##     ont = "BP", universe = all_genes, qvalueCutoff = 0.05, readable = TRUE)
##
##  --- value of length: 90100 type: logical ---
Sys.setenv(
