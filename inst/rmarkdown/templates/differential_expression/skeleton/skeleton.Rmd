...
```{r relevel_examples, eval=FALSE}
# EXAMPLE: Don't run this chunk
...
# If samples have been subset, ensure factor levels match
...
mapply(
    FUN = function(...) {
        plotDEGPCA(..., label = FALSE) %>% show()
        plotDEGPCA(..., label = TRUE) %>% show()
    },
