#' Heatmaps
#'
#' These functions are wrappers to [pheatmap::pheatmap()] that have been
#' optimized to work with a [bcbioRNADataSet] object. They also depend on a
#' [DESeqTransform] object containing transformed counts, which are ideal for
#' heatmap plots.
#'
...
#' (`interesting_groups`) specified in the [bcbioRNADataSet] and then the sample
#' names.
#'
